package by.it.kisielev.jd01_15;
...
public class TaskA {
    public static void main(String[] args) throws IOException {
        ...
        String path = root + "/src/by/it/kisielev/jd01_15/";
        ...
        private static int[][] readListLine (String filename)throws IOException  {
            ...
            try (
                ...
                while (reader.ready()) {
                    rows.add(reader.readLine());//прочитали весь массив
                }

                matrix = new int[rows.size()][0];//создаем массив который будет заполняться
