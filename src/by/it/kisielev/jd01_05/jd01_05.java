 ...
 */
    ...
    private static jd01_05 run(String in) {
        return run(in, true);
    }

    private static jd01_05 run(String in, boolean runMain) {
        ...
        System.out.println("---------------------------------------------");
        return new jd01_05(clName, in, runMain);
    }
    ...
    private jd01_05(String className, String in, boolean runMain) {
