...
public class TaskA {
    ...
    static void printMulTable() {
     ...
     static void buildOneDimArray(String line) {
        ...
        InOut.printArray(array, "V",4);
        int indexFirst=0;
        while (array[indexFirst]!=first) indexFirst++;
        System.out.println("Index of first element=");
        System.out.println("Index of first element="+ Helper.findMin(array));

        /* int indexLast=0;
        * while (array[indexFirst]!=last && indexFirst<=array.lenght) indexLast++;
