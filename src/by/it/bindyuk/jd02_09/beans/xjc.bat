...
set path_xjc="C:\Program Files\Java\jdk-10.0.2\bin\xjc.exe"
set path_to_src="C:\My\JD2018-08-21\src"
set file_xcd="C:\My\JD2018-08-21\src\by\it\bindyuk\jd02_09\Transport.xsd"
