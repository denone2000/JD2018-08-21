...
public class Test_jd01_02 {
    ...
    @Test(timeout = 5000)
    public void testDstep2_Avg__TaskD() throws Exception {
        Test_jd01_02 ok = run("", false);
    ...
    @Test(timeout = 5000)
    public void testTaskDstep3_IndexMinMax__TaskD() throws Exception {
        Test_jd01_02 ok = run("", false);
